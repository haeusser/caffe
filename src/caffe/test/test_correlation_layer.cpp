...
template <typename TypeParam>
void CorrelationLayerTest<TypeParam>::ReferenceCorrelationForward(
...
//TYPED_TEST_CASE(CorrelationLayerTest, ::testing::Types<FloatGPU>);

template <typename TypeParam>
void CorrelationLayerTest<TypeParam>::runFwdTest(const char name[], int n, int c, int h, int w, int k, int pad, int maxdisp, int s1, int s2, CorrelationParameter_CorrelationType corrtype)
{
    typedef typename TypeParam::Dtype Dtype;
...
TYPED_TEST(CorrelationLayerTest, TestForward) {
...
template <typename TypeParam>
void CorrelationLayerTest<TypeParam>::runGradTest(const char name[], int n, int c, int h, int w, int k, int pad, int maxdisp, int s1, int s2, CorrelationParameter_CorrelationType corrtype)
{
    typedef typename TypeParam::Dtype Dtype;
