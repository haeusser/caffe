...
class FormattedResults(models.Model):
    ...
    FlyingStuff3Dnewtestclean = models.FloatField(blank=True, null=True, verbose_name='FlyingStuff3D_new.test.clean', db_column='FlyingStuff3D.test.clean')
    FlyingStuff3Dnewtestfinal = models.FloatField(blank=True, null=True, verbose_name='FlyingStuff3D_new.test.final', db_column='FlyingStuff3D.test.final')
